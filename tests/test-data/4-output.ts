...
export class banana<TBigNumber> extends Contract<TBigNumber> {
	...
	public cherry = async(durian: TBigNumber, options?: { sender?: string, attachedEth?: TBigNumber }): Promise<void> => {
		options = options || {}
		...
		await this.remoteCall(abi, [durian], 'cherry', options.sender, options.attachedEth)
		return
	}
