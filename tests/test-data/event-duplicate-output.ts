...
export const eventDescriptions: { [signatureHash: string]: EventDescription & {signature: string} } = {
	'fbdb8fdfd32e84835a750769f56aef848a42071cd44b719c3add9f069250f83b': {"type":"event","name":"durian","signature":"durian()","inputs":[]}
}
...
export type Event = DecodedEvent | Banana.durian | Banana.durian
