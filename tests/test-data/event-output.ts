...
export const eventDescriptions: { [signatureHash: string]: EventDescription & {signature: string} } = {
	'5c4cf109e00bf95f1fe07fc3173b24b6e8f94894407c6ec23c3e5fb82419a6ce': {"type":"event","name":"Durian","signature":"Durian(uint256,string,bytes,address)","inputs":[{"indexed":false,"name":"a","type":"uint256"},{"indexed":true,"name":"b","type":"string"},{"indexed":false,"name":"c","type":"bytes"},{"indexed":true,"name":"d","type":"address"}]}
}
